import {
  Body,
  Controller, Delete, Param, Patch, Post, UploadedFiles, UseGuards,
} from '@nestjs/common'
import {
...
@Controller(API_ROUTES.ADVERTISEMENT.CONTROLLER)
export class AdvertisementController {
  ...
  @AdvertisementFilesInterceptor()
  public async create(@Body() body:CreateAdvertisementDto,@UploadedFiles() files: Array<Express.Multer.File>) {
  ...
  @UseGuards(RoleAdvertiserGuard)
  @AdvertisementFilesInterceptor()
  public async update(@Param('id') id:string,@Body() body:UpdateAdvertisementDto,@UploadedFiles() files: Array<Express.Multer.File>) {
